...
module Batch60FirstContract where
...
alwaysFails _ _ _ = error () -- traceError "BURNT!"
...
--OFF-CHAIN (Haskell + Plutus Libraries)
...
mkKnownCurrencies []                                                                                 -- MakeKnown currencies for the playg